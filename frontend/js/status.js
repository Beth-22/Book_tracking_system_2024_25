...
function fetchBooks() {
    return __awaiter(this, void 0, void 0, function () {
        var response, books, readBooks, toReadBooks, readingBooks, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    books = _a.sent();
                    readBooks = books.filter(function (book) { return book.status === 1; }).length;
                    toReadBooks = books.filter(function (book) { return book.status === 2; }).length;
                    readingBooks = books.filter(function (book) { return book.status === 3; }).length;
                    // Update the HTML
                ...
                tooltip: {
                    callbacks: {
                        label: function (tooltipItem) {
                            return "".concat(tooltipItem.label, ": ").concat(tooltipItem.raw, " books");
                        },
                    },
                },
            },
